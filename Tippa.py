...
class SignIn(customtkinter.CTk):
    ...
    def initSigninPage(self):
        ...
        self.forgotbutton = CTkButton(self.loginframe, text='Forgot Password?', command=self.goForgotPage)
    ...
    def initRegisterPage(self):
        ...
        self.userentry = CTkEntry(self.regframe,
                                  placeholder_text="Username",
                                  width=240,
                                  height=36,
                                  border_width=2,
                                  corner_radius=10)
        self.userentry.grid(column=1, row=3, padx=400, pady=(10, 10))

        self.passwordentry = CTkEntry(self.regframe, show=self.hiddenState,
                                      placeholder_text="Password",
                                      width=240,
                                      height=36,
                                      border_width=2,
        ...
        self.passwordentry.grid(column=1, row=4, padx=400, pady=(10, 30))

        self.backbuttonreg = CTkButton(self.regframe, text='Back', command=self.goSigninPage)
        self.backbuttonreg.grid(column=1, row=6)
